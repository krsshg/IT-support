...
<div class='rTableRowECHO'>
   <div class= 'rTableHeadingECHO'>Avdeling :</div>
      <div class= 'rTableCellECHO'>
        ...
        <option value='' selected hidden>$LoanerDep</option>
...
<div class='rTableRowECHO'>
   <div class= 'rTableCellECHO'><INPUT TYPE='submit' name ='oppdaterBtn' id='returButton' VALUE='Oppdater'></div>
   <div class= 'rTableCellECHO'><INPUT TYPE='submit' name ='slettBtn' id='returButton2' style='float: right;' VALUE='Slett PC'></div>
</div>
   </form>
   </div>
";
